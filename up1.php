...
$connection=mysqli_connect('localhost','root','');
  ...
  $query=mysqli_query($connection,"update contact set status='not read' where email='$email'");
...
<div id="inbox" style="width: 850px;margin-left: 450px;background-color: #101010;height: 500px;margin-top: -500px;">
  <?php
  $email=$_GET['cd'];
  $query2=mysqli_query($connection,"select * from contact where status='read' and email='$email'");
