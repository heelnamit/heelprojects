...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-3">
  			...
  			<div class="loginForm">
  				<div class="title">
  					<p>LOG INTO<br><span>ADMIN SYSTEM</span></p>
  					<hr>
  					<hr class="short">
  				</div>
  				<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" >
  					<div class="col-3">
			        	<input class="effect-2" type="text" placeholder="Username..." name="uname">
			            <span class="focus-border"></span>

			            <input class="effect-2" type="password" placeholder="Password..." name="psw">
			            <span class="focus-border"></span>
			        </div>
						<button class="button"   name="s">Enter</button></br></br></br>
			        <a href="FINAL PROJECT.php" style="text-decoration:none; color:cyan;"><span class="focus-border"><b>Back to Homepage</b></span></a>
...
$query=mysqli_query($connection,"select * from admin where username='$name' and password='$psw'");
$result=mysqli_fetch_array($query);
if (($result['username']==$name)&&($result['password']==$psw)) {
session_start();
