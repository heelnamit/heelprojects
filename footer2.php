...
<div id="bottom1">
			...
			<div id="a1"style="width:400px;height:auto;position:absolute;left:100px;">
	
				<h5 style="font-family: 'Roboto Slab', sans-serif; color:white; text-align:center;font-weight:700;margin-top:10px;">About Privana</h5>
			...
			<a href="contact.php"> Contact Us</a> </br></br>
				...
				<div id="a3" style="position:absolute;left:780px;">
